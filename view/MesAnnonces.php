...
// Requête pour récupérer les annonces ajoutées par l'utilisateur connecté
$sql = "SELECT * FROM Annonce WHERE userId = :user_id";
$resultat = $connexion->prepare($sql);
$resultat->bindParam(':user_id', $user_id, PDO::PARAM_INT);
$resultat->execute();
...
<head>
    ...
    <title>Liste de Mes Annonces</title>
    <style>
        /* Styles généraux */
        body {
