...
// Requête SQL pour filtrer par catégorie 'informatique'
$sql = "SELECT * FROM Annonce WHERE categorie = 'informatique'";
...
<body>
    <div class="container">
            ...
            <input type="text" name="term" placeholder="Rechercher par nom ou adresse...">
        </form>

        <h1>Liste des Annonces Informatique</h1>
